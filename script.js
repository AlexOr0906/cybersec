...
Служба безопасности ВКонтакте`,
    ...
    options: [
      'Перейду по ссылке и введу данные — аккаунт важен',
      'Удалю письмо и проверю аккаунт напрямую через официальный сайт vk.com',
      'Перешлю друзьям, чтобы предупредить',
      'Отвечу на письмо и попрошу объяснений'
    ],
    correct: 1,
    feedback: {
      title: '✓ Правильно! Это классический фишинг.',
      text: 'Признаки: подозрительный домен (vk-security.NET, а не vk.com), искажённая ссылка (acc0unt с нулём вместо "о"), искусственная срочность. ВКонтакте никогда не присылает письма с адресов на сторонних доменах.',
      wrongTitle: '✗ Это фишинг!',
      wrongText: 'Домен vk-security.net — не официальный ВКонтакте. Ссылка ведёт на мошеннический сайт. Всегда заходи на сервисы только через официальные сайты, набирая адрес вручную.'
    }
  },
  {
    type: 'sms',
...
Всё объясню потом, НЕ ЗВОНИ на мой номер — телефон у чужих людей.`,
    ...
    options: [
      'Немедленно перевожу деньги — сын в беде',
      'Звоню на известный мне номер сына чтобы убедиться, что это он',
      'Перевожу половину суммы пока не убедился',
      'Пишу в ответ и жду подтверждения'
    ],
    correct: 1,
    feedback: {
      title: '✓ Правильно! Это схема «родственник в беде».',
      text: 'Мошенники специально просят не звонить на известный номер. Всегда звони сам на тот номер, который ты знаешь. Если ребёнок реально в беде — он возьмёт трубку или ответит сам.',
      wrongTitle: '✗ Это ловушка!',
      wrongText: 'Фраза «не звони на мой номер» — главный признак мошенничества. Звони сам на известный номер родственника. Мошенники создают искусственную панику, чтобы ты не успел подумать.'
    }
  },
  {
    type: 'browser',
...
<span class="highlight-red">НЕ ЗАКРЫВАЙТЕ это окно!</span> Это может привести к полной потере данных.`,
    ...
    options: [
      'Звоню по номеру — нужно срочно спасать данные',
      'Закрываю вкладку или браузер, игнорирую',
      'Перезагружаю компьютер и запускаю свой антивирус',
      'B и C — сначала закрываю, потом проверяю антивирусом'
    ],
    correct: 3,
    feedback: {
      title: '✓ Отлично! Именно так и нужно.',
      text: 'Настоящие уведомления об угрозах никогда не появляются как всплывающие окна в браузере с телефоном техподдержки. Это scareware — программы-запугиватели. Закрой окно и проверь компьютер своим антивирусом.',
      wrongTitle: '✗ Это scareware — запугивание!',
      wrongText: 'Никакой сайт не может «видеть» вирусы на твоём компьютере. Звонок по указанному номеру приведёт к мошенничеству: тебя попросят установить «утилиту» (на самом деле вредонос) или заплатить за «очистку».'
    }
  },
  {
    type: 'email',
...
Срок действия предложения: 48 часов`,
    ...
    options: [
      'Оплачу комиссию — 450 рублей небольшие деньги, а выплата большая',
      'Это мошенничество: официальные выплаты не требуют оплаты комиссии',
      'Проверю на сайте госуслуг — зайду на gosuslugi.ru сам',
      'B и C — это фишинг, но для уверенности проверю на официальном сайте'
    ],
    correct: 3,
    feedback: {
      title: '✓ Правильно! Идеальная реакция.',
      text: 'Два главных признака мошенничества: неофициальный домен (gosuslugi-bonus.ru вместо gosuslugi.ru) и требование заплатить, чтобы получить деньги. Настоящие государственные выплаты не требуют комиссий.',
      wrongTitle: '✗ Это фишинговая ловушка!',
      wrongText: '«Заплати чтобы получить» — классическая схема мошенничества. Ты заплатишь 450 рублей и введёшь данные карты. Никакой выплаты не будет, а данные карты окажутся у мошенников.'
    }
  },
  {
    type: 'chat',
...
[PRO_player_777]: только побыстрее, акция до конца дня. уже 2000 игроков получили`,
    ...
    options: [
      ...
      'Игнорирую: сотрудники игры не раздают призы через личные сообщения',
      'Спрашиваю у него промокод для подтверждения',
      'Рассказываю другу, может он тоже захочет'
    ],
    correct: 1,
    feedback: {
      title: '✓ Правильно! Типичный стим-фишинг.',
      text: 'Никакая игровая компания не раздаёт призы через личные сообщения в чате. Сайт free-skins-cs.net создан для кражи аккаунтов Steam. Если зайдёшь и введёшь данные — потеряешь аккаунт.',
      wrongTitle: '✗ Это кража аккаунта!',
      wrongText: 'Сайт имитирует страницу Steam для входа, но украдёт твои данные. Фраза «2000 игроков уже получили» создаёт социальное давление. Компании никогда не раздают призы через чат рандомным игрокам.'
    }
  }
];
